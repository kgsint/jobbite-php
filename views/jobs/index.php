...
<main class="container max-w-[1135px] mx-auto py-10 mt-12">
  <h2 class="text-center text-2xl mb-2">Latest Jobs</h2>
  <div class="grid place-items-center md:space-y-12">
    
  <?php foreach($jobs as $job) :?>
    <a href="/jobs/job?id=<?= $job->id ?>" class="flex items-center jusify-between w-full bg-white border border-gray-200 rounded-lg shadow flex-row max-w-3xl hover:bg-gray-100">
